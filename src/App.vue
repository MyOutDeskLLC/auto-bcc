                    ...
                    <div class="flex items-center space-x-2">
                        <SwitchGroup as="div" class="flex items-center justify-between w-full">
                            <span class="flex flex-grow flex-col">
                              ...
                              <SwitchDescription as="span" class="text-xs text-gray-500">Toggling this option will make allow users to opt in to turn auto bcc on per email. </SwitchDescription>
                            </span>
