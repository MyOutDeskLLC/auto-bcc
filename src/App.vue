<template>
    <div class="flex min-h-screen flex-col items-center justify-center">
        <div class="grid grid-cols-3 rounded border border-gray-200 shadow max-w-3xl w-full">
            <div class="col-span-2 overflow-y-auto" style="height: 550px;">
                <NewRule @rule-added="getRulesFromStorage"/>
            </div>
            <div class="col-span-1 bg-stone-50 border-l overflow-y-auto" style="height: 550px;">
...
<script setup>
    ...
    function saveRules(value) {
        chrome.storage.local.set({bccRules: value}, () => {
        });
    }
