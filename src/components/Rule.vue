    ...
    <div class="p-2 text-xs">
        <div class="flex items-center space-x-2">
            <div class="flex-grow text-sm">
                ...
                <div class="p-1 text-xs">{{ truncateEmail(emailKey) }}</div>
            </div>
            <div>
